...
export const getChatSession = (language = 'en') => {
...
export const generateArtifact = async (prompt, type, language = 'en') => {
...
export const sendMessageToElsi = async (text, language = 'en') => {
